...
class ContactForm(forms.Form):
    ...
    passport = forms.CharField(label="PASAPORTE",min_length=0,max_length=11,required=False)
    ...
    interest = forms.MultipleChoiceField(widget=forms.CheckboxSelectMultiple,choices=(('Turismo','Turismo'),('Trabajo','Trabajo'),('Negocios','Negocios')))
